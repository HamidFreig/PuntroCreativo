...
const WhatsAppButton = () => {
  return (
    <a
      ...
      className="fixed bottom-8 right-8 flex items-center bg-green-500 text-white rounded-full px-4 py-3 shadow-lg hover:bg-green-600 transition"
      style={{ zIndex: 1000 }}
    >
      <i className="fab fa-whatsapp text-2xl mr-3"></i>
      <span className="text-sm font-medium">Consultas por acá</span>
    </a>
  );
};
